...
$objPHPExcel->getProperties()->setCreator("Plataforma EQUAS")
							 ...
							 ->setDescription("Este documento contiene el listado de parametros registrada en la base de datos.")
							 ->setCategory("Reporte");
...
$objWriter->save('/var/www/equas/app/static/xls/reporteParametros.xlsx');*/
